                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6">
                                <label class="input-exp d-block label-cad label-cad-perfil">
                                    <input type="text" placeholder="nome completo" value="Osmar Luiz Oliveira">
                                </label>
                            </div>
                            <div class="col-12 col-lg-6">
                                <label class="input-exp d-block label-cad label-cad-fone">
                                    <input type="tel" placeholder="fone" value="00 9 0000-0000">
                                </label>
                            </div>
                            <div class="col-12 col-lg-6">
                                <label class="input-exp d-block label-cad label-cad-email">
                                    <input disabled type="text" placeholder="e-mail" value="seuemail@naoeditavel.com">
                                </label>
                            </div>
                            <div class="col-12 col-lg-6">
                                <label class="input-exp d-block label-cad label-cad-senha">
                                      <input type="password" placeholder="digite sua senha" value="098098as">
                                </label>
                            </div>
                            <div class="col-12 col-lg-6">
                                <label class="input-exp d-block label-cad label-cad-senha">
                                      <input type="password" placeholder="confirmar senha" value="098098as">
                                </label>
                            </div>
                        </div>
					</div>
