			...
			<div class="col-12 col-lg-9">
				<div class="bloco-exp">
					<div class="container">
						<div class="row">
							<div class="col-12">
								<h4 title="clientes cadastrados">Cliente João Pedro</h4>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="d-inline-flex row-center">
                                    <h5>Fazendas</h5><span id="cad-fazenda" class="action-add-min c-pointer" title="cadastrar nova fazenda"></span>
                                </div>
                                <div class="clear space-min"></div>
                            </div>
                        </div>
                        <?php include('includes/row-fazendas.php');?>
					</div>
				</div>
			</div>
